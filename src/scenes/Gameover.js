class Gameover extends Phaser.Scene {
    ...
    create() {
        ...
        this.add.text(centerX, centerY - 80, 'Game Over', { fontSize: '32px', fill: '#FFF' }).setOrigin(0.5);
    
        // Display "Score" text
        this.add.text(centerX, centerY - 40, 'Score', { fontSize: '28px', fill: '#FFF' }).setOrigin(0.5);
        ...
        // Create score text
        this.scoreText = this.add.text(centerX, centerY, '0', { fontSize: '40px', fill: '#FFD700' }).setOrigin(0.5);



        // Add "Press Space to go back to main scene" text - All the way at the buttom - Blinking
        this.add.text(centerX  , 380, 'Press Space to Continue', { fontSize: '24px', fill: '#FFF' }).setOrigin(0.5);
